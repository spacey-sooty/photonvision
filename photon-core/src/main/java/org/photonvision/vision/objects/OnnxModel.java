...
public class OnnxModel implements Model {
     ...
     */
    public OnnxModel(ModelProperties properties) throws IllegalArgumentException {
        ...
        if (properties.version() != Version.YOLOV5) {
            throw new IllegalArgumentException("Model version must be YOLOV5");
        }
    ...
    public String toString() {
        return "OnnxModel{" + "modelFile=" + modelFile + ", properties=" + properties + '}';
    }
}
